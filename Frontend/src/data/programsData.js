// programsData is an array of objects and has 4 obj
  ...
  },
  {
    image: (
      ...
      >
        <path
          id="primary"
          d="M20,16H18.82L18,12h.07a1,1,0,1,0-.44-2L8.78,12l-.1,0L3.37,13.82A2,2,0,0,0,2,15.72V17a1,1,0,0,0,2,0V15.72L9.27,14l6.8-1.53.79,4a2,2,0,0,0,2,1.61H20a1,1,0,0,0,0-2Z"
          style={{ fill: "rgb(0, 0, 0)" }}
        ></path>
        <path
          id="secondary"
          d="M9,14.5a1.5,1.5,0,0,1-.33-3l8-1.81a1.5,1.5,0,1,1,.66,2.93l-8,1.8A1.24,1.24,0,0,1,9,14.5Z"
          style={{ fill: "rgb(0, 0, 0)" }}
        ></path>
        <circle
          id="primary-2"
  ...
  },
  {
    image: (
      ...
      >
        <path
          id="primary"
          d="M15,8H11.05a1,1,0,0,0-.84-1,1,1,0,0,0-1.13.85L8,15.36a1,1,0,0,0,.89,1.13l4,.4-.78,3.91A1,1,0,0,0,12.88,22l.19,0a1,1,0,0,0,1-.8l.78-3.92a2,2,0,0,0-1.76-2.38l-2.93-.29L10.8,10a1.42,1.42,0,0,0,.2,0h4a1,1,0,0,0,0-2Z"
          style={{ fill: "rgb(0, 0, 0)" }}
        ></path>
        <path
          id="secondary"
          d="M9.07,16.5H8.86a1.5,1.5,0,0,1-1.27-1.7l1-7a1.5,1.5,0,1,1,3,.42l-1,7A1.51,1.51,0,0,1,9.07,16.5Z"
          style={{ fill: "rgb(0, 0, 0)" }}
        ></path>
        <circle
          id="primary-2"
